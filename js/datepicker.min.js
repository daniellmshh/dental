var Datepicker = function() {
    ...
    const D = {
        ...
        m(e, t, i) {
            ...
            if (isNaN(a)) {
                ...
                return (a = i.monthsShort.findIndex(n)) < 0 && (a = i.months.findIndex(n)),
                a < 0 ? NaN : s.setMonth(a)
            }
            return s.setMonth(a),
            s.getMonth() !== function e(t) {
    ...
    function W(e) {
        "none" !== e.style.display && (e.style.display && (e.dataset.styleDisplay = e.style.display),
        e.style.display = "none")
    }
    function A(e) {
        "none" === e.style.display && (e.dataset.styleDisplay ? (e.style.display = e.dataset.styleDisplay,
        delete e.dataset.styleDisplay) : e.style.display = "")
    }
    function K(e) {
        e.firstChild && (e.removeChild(e.firstChild),
        K(e))
    }
    const {language: T, format: H, weekStart: $} = N;
    function j(e, t) {
    ...
    function q(t, s) {
        ...
        let {format: d, language: o, locale: c, maxDate: h, maxView: u, minDate: f, pickLevel: p, startView: m, weekStart: g} = s.config || {};
        if (a.language) {
            let e;
            if (a.language !== o && (r[a.language] ? e = a.language : void 0 === r[e = a.language.split("-")[0]] && (e = !1)),
            delete a.language,
            e) {
                o = n.language = e;
                const t = c || r[T];
                ...
                g === t.weekStart && (g = n.weekStart = c.weekStart,
                n.weekEnd = _(c.weekStart))
            }
        }
        if (a.format) {
            const e = "function" == typeof a.format.toDisplay
              ...
              , i = w.test(a.format);
            (e && t || i) && (d = n.format = a.format),
            delete a.format
        }
        let y = f
          , k = h;
        if (void 0 !== a.minDate && (y = null === a.minDate ? l(0, 0, 1) : P(a.minDate, d, c, y),
        delete a.minDate),
        void 0 !== a.maxDate && (k = null === a.maxDate ? void 0 : P(a.maxDate, d, c, k),
        delete a.maxDate),
        k < y ? (f = n.minDate = k,
        h = n.maxDate = y) : (f !== y && (f = n.minDate = y),
        h !== k && (h = n.maxDate = k)),
        a.datesDisabled && (n.datesDisabled = a.datesDisabled.reduce((e,t)=>{
            const s = M(t, d, c);
        ...
        void 0 !== a.defaultViewDate) {
            ...
            delete a.defaultViewDate
        }
        if (void 0 !== a.weekStart) {
            const e = Number(a.weekStart) % 7;
            isNaN(e) || (g = n.weekStart = e,
            n.weekEnd = _(e)),
            delete a.weekStart
        }
        if (a.daysOfWeekDisabled && (n.daysOfWeekDisabled = a.daysOfWeekDisabled.reduce(j, []),
        delete a.daysOfWeekDisabled),
        a.daysOfWeekHighlighted && (n.daysOfWeekHighlighted = a.daysOfWeekHighlighted.reduce(j, []),
        delete a.daysOfWeekHighlighted),
        void 0 !== a.maxNumberOfDates) {
            const e = parseInt(a.maxNumberOfDates, 10);
            e >= 0 && (n.maxNumberOfDates = e,
            n.multidate = 1 !== e),
            delete a.maxNumberOfDates
        }
        a.dateDelimiter && (n.dateDelimiter = String(a.dateDelimiter),
        delete a.dateDelimiter);
        let D = p;
        void 0 !== a.pickLevel && (D = I(a.pickLevel, 2),
        delete a.pickLevel),
        D !== p && (p = n.pickLevel = D);
        let v = u;
        void 0 !== a.maxView && (v = I(a.maxView, u),
        delete a.maxView),
        (v = p > v ? p : v) !== u && (u = n.maxView = v);
        let b = m;
        if (void 0 !== a.startView && (b = I(a.startView, b),
        delete a.startView),
        b < p ? b = p : b > u && (b = u),
        b !== m && (n.startView = b),
        a.prevArrow) {
        ...
        if (void 0 !== a.disableTouchKeyboard && (n.disableTouchKeyboard = "ontouchstart"in document && !!a.disableTouchKeyboard,
    ...
    class z {
        ...
        performBeforeHook(e, t, s) {
            ...
            if (a) {
                if (!1 === a.enabled && (e.classList.add("disabled"),
                i(this.disabled, t)),
                a.classes) {
                ...
                a.content && function(e, t) {
                    K(e),
                    t instanceof DocumentFragment ? e.appendChild(t) : "string" == typeof t ? e.appendChild(Y(t)) : "function" == typeof t.forEach && t.forEach(t=>{
                        e.appendChild(t)
                    }
                    )
                }(e, a.content)
    ...
    class X extends z {
        ...
        setOptions(t) {
            let i;
            if (e(t, "minDate") && (this.minDate = t.minDate),
            ...
            void 0 !== t.showDaysOfWeek && (t.showDaysOfWeek ? (A(this.dow),
            this.calendarWeeks && A(this.calendarWeeks.dow)) : (W(this.dow),
        ...
        render() {
            if (this.today = this.todayHighlight ? c() : void 0,
            ...
            Array.from(this.grid.children).forEach((e,t)=>{
                const s = e.classList
                  ...
                  , n = new Date(a)
                  , r = n.getDay();
                if (e.className = `datepicker-cell ${this.cellClass}`,
                e.dataset.date = a,
                ...
                this.daysOfWeekDisabled.includes(r) && (s.add("disabled"),
                i(this.disabled, a)),
    ...
    class Q extends z {
        ...
        updateSelection() {
            ...
            this.selected = e.reduce((e,t)=>{
                const s = new Date(t)
                  , a = s.getFullYear()
                  , n = s.getMonth();
                return void 0 === e[a] ? e[a] = [n] : i(e[a], n),
                e
            }
            , {}),
        ...
        render() {
            ...
            Array.from(this.grid.children).forEach((n,r)=>{
                const d = n.classList
                  , o = l(this.year, r, 1);
                if (n.className = `datepicker-cell ${this.cellClass}`,
    ...
    class Z extends z {
        ...
        setOptions(t) {
            if (e(t, "minDate") && (void 0 === t.minDate ? this.minYear = this.minDate = void 0 : (this.minYear = g(t.minDate, this.step),
            this.minDate = l(this.minYear, 0, 1))),
            e(t, "maxDate") && (void 0 === t.maxDate ? this.maxYear = this.maxDate = void 0 : (this.maxYear = g(t.maxDate, this.step),
    ...
    function ne(t, i) {
        if (void 0 !== i.title && (i.title ? (t.controls.title.textContent = i.title,
        A(t.controls.title)) : (t.controls.title.textContent = "",
        W(t.controls.title))),
        i.prevArrow) {
        ...
        if (i.locale && (t.controls.todayBtn.textContent = i.locale.today,
        t.controls.clearBtn.textContent = i.locale.clear),
        void 0 !== i.todayBtn && (i.todayBtn ? A(t.controls.todayBtn) : W(t.controls.todayBtn)),
    ...
    class ce {
        ...
        place() {
            ...
            let p, m, g, {x: w, y: y} = i.orientation;
            a === document.body ? (p = window.scrollY,
            m = l + window.scrollX,
            g = h + p) : (m = l - d,
            g = h - o + (p = a.scrollTop)),
            "auto" === w && (m < 0 ? (w = "left",
            m = 10) : w = m + n > c ? "right" : "rtl" === oe(s) ? "right" : "left"),
            "right" === w && (m -= n - u),
        ...
        changeView(e) {
            const t = this.currentView
              , i = this.views[e];
            return i.id !== t.id && (this.currentView = i,
        ...
        changeFocus(e) {
            return this._renderMethod = de(this, e) ? "render" : "refreshFocus",
        ...
        update() {
            ...
            return this._renderMethod = de(this, e) ? "render" : "refresh",
            this.views.forEach(e=>{
                e.updateFocus(),
                e.updateSelection()
            }
    ...
    function le(e, t, i, s) {
        ...
        void 0 !== (l = function e(t, i, s, n, r, d) {
            if (a(t, r, d))
                return n(t) ? e(i(t, s), i, s, n, r, d) : t
    ...
    function ue(e, t, i=!1) {
        ...
        let o = t.reduce((e,t)=>{
            ...
            return !a(i, s.minDate, s.maxDate) || e.includes(i) || s.datesDisabled.includes(i) || s.daysOfWeekDisabled.includes(new Date(i).getDay()) || e.push(i),
            e
        }
        , []);
        return 0 !== o.length ? (s.multidate && !i && (o = o.reduce((e,t)=>(n.includes(t) || e.push(t),
        e), n.filter(e=>!o.includes(e)))),
    ...
    function pe(e, t, i) {
        ...
        const r = ue(e, t, s);
        r && (r.toString() !== e.dates.toString() ? (e.dates = r,
        fe(e, a ? 3 : 1),
        ee(e, "changeDate")) : fe(e, 1),
        n && e.hide())
    }
    return class {
        constructor(e, t={}, i) {
            ...
            if (i && "DateRangePicker" === i.constructor.name) {
                ...
                i.datepickers[e] = this,
                Object.defineProperty(this, "rangepicker", {
                    get: ()=>i
                })
            }
            this.dates = ue(this, d) || [],
            r && (r.value = he(this.dates, a));
            ...
            if (n)
                ...
                .bind(null, this)], [r, "mousedown", function(e, t) {
                    const i = t.target;
                    (e.picker.active || e.config.showOnClick) && (i._active = i === document.activeElement,
                ...
                .bind(null, this)], [document, "mousedown", e], [document, "touchstart", e], [window, "resize", o.place.bind(o)]])
            }
        }
        ...
        setDate(...e) {
            const i = [...e]
              , s = {}
              , a = t(e);
            "object" != typeof a || Array.isArray(a) || a instanceof Date || !a || Object.assign(s, i.pop()),
